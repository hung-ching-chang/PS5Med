...
## large p --- 1000 mediators
#dirpath <-  "~/OneDrive/Pitts/COPD/mediation_analysis/simulation/type1/N500p1000/S3"
#dir.create(dirpath) 
#setwd(dirpath)
...
# type1error
save(type1error, file = paste0("type1error_N", N, "p", p,"_cor", cov.setting, "_S", scenario.setting, ".RData"))
